<div class='container-fluid'>
	...
	<?php if (@$_GET['type'] == 'add') { ?>
		...
		<div class='box'>
			<div class='header'>
				THÊM MỚI BÀI HÁT
				<button type="button" class="btn btn-default pull-right" style="position: relative;top: -7px;" onclick="window.location='<?php echo BASE_URL ?>?pages=baihat'">QUAY LẠI</button>
			</div>
			<div class='body'>
	...
	<?php } elseif (@$_GET['type'] == 'del') {
		...
		<div class='box'>
			<div class='header'>
				DANH SÁCH BÀI HÁT
				<button type="button" class="btn btn-default pull-right" style="position: relative;top: -7px;" onclick="window.location='<?php echo BASE_URL ?>?pages=baihat&type=add'">THÊM MỚI</button>
			</div>
			<div class='body'>

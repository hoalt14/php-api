		...
		<div class='box'>
			<div class='header'>
				...
				<button type="button" class="btn btn-default pull-right" 
					...
					onclick="window.location='<?php echo BASE_URL ?>?pages=chude'" 
				>QUAY LẠI</button>
			</div>
			<div class='body'>
	...
	<?php }elseif(@$_GET['type']=='del'){ 
		...
		<div class='box'>
			<div class='header'>
				...
				<button type="button" class="btn btn-default pull-right" 
					style="position: relative;top: -7px;"
					onclick="window.location='<?php echo BASE_URL ?>?pages=chude&type=add'" 
				>THÊM MỚI</button>
			</div>
			<div class='body'>
							...
							if ($result->num_rows > 0) {
							    while($row = $result->fetch_assoc()) {
							    	echo"<tr>
											...
											<td><a href='".BASE_URL."?pages=chude&type=add&id=$row[idChuDe]'>Sửa</a></td>
											<td><a href='".BASE_URL."?pages=chude&type=del&id=$row[idChuDe]'>Xóa</a></td>
										</tr>";
							    }
							}
							$conn->close();
